...
PROTOCOL='BC250_RELAY_V3'; VERSION='3.2'; SESSIONS=('fsr4','ps5','vcn')
    ...
    def loop(self):
        ...
        while True:
            try:
                ...
                if now-hb>float(self.cfg.get('heartbeat_seconds',300)):self.status(); hb=now
