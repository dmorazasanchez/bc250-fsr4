...
BASE="${BASE:-/home/david/fsr4-probes/native-exp105}"
SRC="$BASE/mesa"
BD="$BASE/build"
OUT="$ROOT/experiments/EXP-105-UDOT-SDOT-EMULATION/libvulkan_radeon-exp105.so"
...
git -C "$SRC" apply "$ROOT/experiments/EXP-105-UDOT-SDOT-EMULATION/exp105-udot-sdot.patch"
